        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title "><b>Customer Details</b>
                  <button type="button" class="float-right btn btn-secondary"  onclick="window.location.href = 'createcus.php';">Create Customer Account</button>
                  </h4>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title "><b>Driver Details</b>
                  <button type="button" class="float-right btn btn-secondary"  onclick="window.location.href = 'createdriv.php';">Create Driver Account</button>
                  </h4>
