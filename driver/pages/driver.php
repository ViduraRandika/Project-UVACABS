...
$sql1 = "SELECT * FROM booking INNER JOIN onlinepayment ON booking.bookingId = onlinepayment.bookingId WHERE booking.driverNic = '$nic' AND booking.status = 'notcompleted'";
